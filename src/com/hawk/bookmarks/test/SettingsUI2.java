...
import com.hawk.bookmarks.ui.bk26_5_27.ConfigBrowserPath;
import com.hawk.bookmarks.ui.bk26_5_27.FloatUI;
...
//			System.out.println("brsConfigs="+brsConfigs);
		...
		springLayout.putConstraint(SpringLayout.SOUTH, okBtn, -10, SpringLayout.SOUTH, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, okBtn, -191, SpringLayout.EAST, getContentPane());
		...
		public ButtonEditor(JCheckBox checkBox) {
			...
			button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(btnTxt.equals("开启")){
						String repPath=new ConfigBrowserPath().showDialog(SettingsUI2.this,button.getActionCommand());
